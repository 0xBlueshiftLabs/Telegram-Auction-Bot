...
const initiateAuction: () => void = () => {
  task("initiateAuction", "Starts a new auction")
    ...
    .addVariadicPositionalParam("strategyInitParams","Init params for the specific strategy - default empty array",[])
    .setAction(async (taskArgs, hardhatRuntime) => {
      ...
      const referralFeeNumerator = BigNumber.from(taskArgs.referralFeeNumerator)
